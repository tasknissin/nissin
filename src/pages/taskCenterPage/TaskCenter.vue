<template>
  <div class="page" id="taskManagePage" ref="taskconTable" v-loading="loading" :element-loading-text="loadText" element-loading-background="rgba(255, 255, 255, 1)">
    ...
    <app-content >
      ...
      <el-dialog title="新增任务" :visible.sync="dialogFormVisible" @close="cancelHandel" >
        <el-form  :inline="true"  :model="form"  size="small" label-width="100px">
          ...
          <el-form-item class="textAreaItem" label="任务内容"  prop="context">
            <el-input type="textarea" v-model="form.context" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item class="textAreaItem" label="目标与要求"  prop="standard">
            <el-input type="textarea" v-model="form.standard" auto-complete="off"></el-input>
          </el-form-item>
...
#taskManagePage .el-input--prefix .el-input__inner{
  padding-right: 0px;
}
...
#taskManagePage .el-textarea__inner{
    padding:5px 10px;
    min-height: 70px !important;
}
#taskManagePage .textAreaItem{
  width:92%;
  max-width: 92%;
}
#taskManagePage .textAreaItem .el-form-item__content{
  width:79%;
  color: #606266;
}
.selectbox{
